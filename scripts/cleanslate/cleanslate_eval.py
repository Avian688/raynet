...
if __name__ == '__main__':
    ...
    max_steps_range = (200000, 200000)                   # Custom: Randomize ending time slightly so threads desync, to make log outputs less sparse
    bottleneck_bandwidth_range = (6, 6)            
    minimum_rtt_range = (5, 5)
    bottleneck_buffer_range = (5280000, 5280000) 
    load_from_checkpoint = True
    checkpoint_load_dir = os.getenv('HOME') + "/ray_results/CleanSlate-1.0/SAC_CleanSlate_2026-03-12_01-39-02ukss_q70/checkpoints/checkpoint_11"
