// Just here for reference and backup. Delete once you get a new training setup working on the dumbbell.

// #include "JamesAgent.h"

// Define_Module(JamesAgent);

// JamesAgent::~JamesAgent(){
//     cancelAndDelete(initMsg);
// }

// void JamesAgent::initialize()
// {
//     steps=0;	
//     gravity = 9.8;
//     masscart = 1.0;
...
//     initMsg = new cMessage("JAMESAGENT-INIT"); 
//     scheduleAt(simTime() + 1, initMsg);
// }
// void JamesAgent::handleMessage(cMessage *msg)
// {
...
// void JamesAgent::step(ActionType action)
// {
//     double x = state[0];
...
// void JamesAgent::cleanup(){}

// void  JamesAgent::decisionMade(ActionType action){
//     if(this->isReset){
...
// ObsType JamesAgent::getRLState(){
//     return state;
// }

// RewardType JamesAgent::getReward(){
//     RewardType reward;
//     if (done == false)
//     {
//         reward = 1.0;
...
// }
// void JamesAgent::resetStepVariables(){

// }
// ObsType JamesAgent::computeObservation(){
//     return getRLState();

// }
// RewardType JamesAgent::computeReward(){
//     return getReward();
// }

// void JamesAgent::finish(){
